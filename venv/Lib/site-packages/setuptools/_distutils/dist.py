...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # parsing them (from main files, the command-line, etc.) and when
        ...
        # because other args override the main files, and this
        # one is needed before we can load the main files.
    ...
    def find_config_files(self):
        ...
        There are multiple possible main files:
        ...
        if DEBUG:
            self.announce("using main files: %s" % ', '.join(files))

        return files

    def _gen_paths(self):
        # The system-wide Distutils main file
        sys_dir = pathlib.Path(sys.modules['distutils'].__file__).parent
        yield sys_dir / "distutils.cfg"

        # The per-user main file
        ...
        # Additional main indicated in the environment
    ...
    def parse_config_files(self, filenames=None):  # noqa: C901
        ...
        # If there was a "global" section in the main file, use it
    ...
    def get_command_obj(self, command, create=1):
        ...
        if not cmd_obj and create:
            ...
            # Set any options that were supplied in main files
    ...
    def reinitialize_command(self, command, reinit_subcommands=0):
        ...
        user-supplied values from the main files and command line.
