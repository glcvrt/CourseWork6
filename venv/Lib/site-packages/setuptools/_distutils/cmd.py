...
class Command:
    ...
    world (command line, main file, ...), and any options dependent on
    ...
    #     setup script, by options from main file(s), or by command-line
    #     options
    #   finalize_options()
    ...
    def initialize_options(self):
        ...
        commands, by the setup script, by main files, or by the
    ...
    def run(self):
        ...
        script, the command-line, and main files, and finalized in
