...
def validate(config: dict, filepath: _Path) -> bool:
    ...
    try:
        ...
        error = f"invalid pyproject.toml main: {ex.name}."
...
def _skip_bad_config(
    ...
    if setuptools_cfg:
        # If `[tool.setuptools]` is set, then `pyproject.toml` main is intentional
        return False
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        """
        # If anything was discovered set them back, so they count in the final main.
