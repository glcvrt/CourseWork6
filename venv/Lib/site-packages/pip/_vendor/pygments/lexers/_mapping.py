...
LEXERS = {
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.configs', 'Docker', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-main',)),
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-main', 'kernel-main'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'UnixConfigLexer': ('pip._vendor.pygments.lexers.configs', 'Unix/Linux main files', ('unixconfig', 'linuxconfig'), (), ()),
